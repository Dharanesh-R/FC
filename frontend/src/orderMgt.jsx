...
//       try {
//         const response = await axios.get('http://localhost:3001/api/preorders');
//         if (Array.isArray(response.data)) {
...
//       } else {
//         setFilteredPreorders(preorders.filter(order => order.deliveryType === activeOrderType));
//       }
//     };

//     filterPreorders();
//   }, [activeOrderType, preorders]);
...
//     if (inputCode === orderCode) {
//       try {
//         await axios.put(`http://localhost:3001/api/preorders/${orderId}`, { orderStatus: 'Completed' });
//         setFilteredPreorders(filteredPreorders.map(order => 
...
//         <div className='place'>
//           <img src={rooster} width={100} height={100} alt='Rooster Logo' />
//           <h2 className='hea'>Preorder Management</h2>
//         </div>
//         <hr /><br />
        
//         <div className='counts'>
//           <p>Total Preorders: {filteredPreorders.length}</p>
//         </div>
...
//           </div>
//           <div className='shortitems'>
//             <button onClick={() => handleFilterByType('All')} className='btns'>All Preorders</button>
//             <button onClick={() => handleFilterByType('Takeaway')} className='btns'>Takeaway Preorders</button>
//             <button onClick={() => handleFilterByType('Table Booking')} className='btns'>Table Booking Preorders</button>
//             <button onClick={() => handleFilterByType('Home Delivery')} className='btns'>Home Delivery Preorders</button>
//           </div>
//         </div>
...
//                         </div>
//                       ) : (
//                         <button onClick={() => handleCompleteClick(order._id)} className='btns'>Mark as Completed</button>
//                       )
//                     )}
//                   </td>
//                 </tr>
